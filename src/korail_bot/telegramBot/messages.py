...
"""
    ...
    # ========== 뒤로가기 ==========
    #
    # 되돌아온 단계의 질문을 다시 묻는 문구다. 앞으로 갈 때 쓰는 안내문은
    # 하나같이 "✅ ... 입력 완료" 로 시작하는데, 뒤로 온 사람에게 방금 지운
    # 답을 완료했다고 말하는 셈이라 그대로 재사용할 수 없다.
    #
...
예시: 20250425 (2025년 4월 25일)"""
    ...
    BACK_TO_SRC_STATION = BACK_PREFIX + "🚉 출발역을 다시 선택해주세요."

    BACK_TO_DST_STATION = BACK_PREFIX + "🏁 도착역을 다시 선택해주세요."
...
💡 1~9명까지 선택 가능합니다."""
    ...
    BACK_TO_SEAT_STRATEGY = (
        BACK_PREFIX
        + """🪑 좌석 배치 방식을 다시 선택해주세요. (총 {count}명)
