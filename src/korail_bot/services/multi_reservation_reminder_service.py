            ...
            while True:
                ...
                if not status.should_show_reminder():
                    ...
                    if status.manually_stopped:
                        logger.info(
                            f"Manually stopped by user, ending reminders for chat_id={chat_id}"
                        )
                    else:
                        logger.info(
                            f"No pending reservations left, ending reminders for chat_id={chat_id}"
                        )
                    break
