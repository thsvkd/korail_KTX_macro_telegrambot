...
열을 눌러 고르시거나, 번호 범위를 입력하세요 (예: 1-15)."""
    ...
    # 코레일에서 좌석 조건을 물을 수 없는 이유. 물어보지 않고 넘어가면 기능이
    # 없는 것처럼 보이므로, 왜 안 나오는지는 밝힌다.
    SEAT_PREFERENCE_KORAIL_ONLY = """ℹ️ 좌석 지정은 SRT 예약에서만 지원됩니다.

코레일은 결제를 마치기 전까지 어느 좌석을 잡았는지 알려주지 않아,
조건에 맞는지 확인할 방법이 없습니다."""
